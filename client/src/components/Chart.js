...
const ChartJs = ({ chartType, viewBy }) => {
  ...
  const datasetStyle = {
    ...
    pointHoverBorderColor: chart_colors.lineShadow,
  };
  const data = {
    ...
    datasets: [
      {
        ...
        pointBackgroundColor: chart_colors.sales_line,
        pointHoverBackgroundColor: chart_colors.sales_line,
      ...
      },
      {
        ...
        pointBackgroundColor: chart_colors.expenses_line,
        pointHoverBackgroundColor: chart_colors.expenses_line,
